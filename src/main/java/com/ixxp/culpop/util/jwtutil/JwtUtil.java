...
public class JwtUtil {
    ...
    // 토큰 생성
    public String createToken(String email, long TOKEN_TIME, String prefix) {
        Date date = new Date();
    ...
    public String createAccessToken(String email) {
        return createToken(email, ACCESS_TOKEN_TIME, BEARER_PREFIX);
    }

    //refreshToken 생성
    public String createRefreshToken(String email) {
        return createToken(email, REFRESH_TOKEN_TIME, REFRESH_PREFIX);
    }
